
{
	...
	["ALL",[_object,['','noscript.sqf','',-1,false,true,'LeanRight',format['player distance _target < 5 && {!([_target,"Take %1 (E)",""]call tag_show)}',_name]]],"network_addAction",false,true]call network_MPExec;
